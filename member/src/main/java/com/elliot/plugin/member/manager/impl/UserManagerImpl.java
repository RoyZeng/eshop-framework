...
import com.elliot.framework.utils.DecodeUtil;
import com.elliot.framework.utils.StringUtil;
import com.elliot.plugin.member.context.UserContext;
import com.elliot.plugin.member.manager.IAdminUserManager;
import com.elliot.plugin.member.manager.ISiteManager;
import org.apache.log4j.Logger;
import org.springframework.transaction.annotation.Propagation;
import org.springframework.transaction.annotation.Transactional;

import com.elliot.plugin.member.manager.IUserManager;
import com.elliot.plugin.member.model.EopUser;
...
public class UserManagerImpl implements IUserManager {
	...
	public int login(String username, String password) {
		...
		try{
			...
			if(user.getPassword().equals( DecodeUtil.md5(password) )){
				result =1;
