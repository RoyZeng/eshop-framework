...
import com.elliot.plugin.member.manager.*;
import com.elliot.plugin.member.model.*;
...
import com.elliot.framework.database.ISqlFileExecutor;
import com.elliot.framework.database.Page;
import com.elliot.framework.database.StringMapper;
...
public class SiteManagerImpl implements ISiteManager {
	...
	public void delete(Integer id) {
		...
		// 删除文件
		String userTplFile = ParamSetting.EOP_PATH + "/user/" + userid + "/"
				+ siteid;
	...
	public EopSite get(Integer id) {
		...
		if (icofile != null)
			icofile = StringUtil.replacePath(icofile);
		site.setIcofile(icofile);
